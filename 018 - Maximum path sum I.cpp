// same code of problem 067 - Maximum path sum II
// I used dynamic programming (memoization, here) to speed up the code
#include <cstring>
#include <iostream>
#include <cmath>
#define MAX 102
...
int main(){
    ...
    cout<<solve(0, n-1)<<endl; // start from the top cell
    return 0;
}
